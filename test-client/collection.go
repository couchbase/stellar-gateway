...
func (c *Collection) Increment(ctx context.Context, id string, opts *IncrementOptions) (*CounterResult, error) {
	if opts == nil {
...
func (c *Collection) Decrement(ctx context.Context, id string, opts *DecrementOptions) (*CounterResult, error) {
	if opts == nil {
