...
func Register(s *grpc.Server, topologyProvider topology.Provider, client *gocb.Cluster) {
	couchbase_v1.RegisterCouchbaseServer(s, NewCouchbaseServer())
	routing_v1.RegisterRoutingServer(s, NewRoutingServer(topologyProvider))
